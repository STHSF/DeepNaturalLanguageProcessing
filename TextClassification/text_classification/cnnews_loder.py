...
def process_file(filename, word_to_id, cat_to_id, max_length=10):
    """将文件转换为id表示"""
    ...
    for i in range(len(contents)):
        ...
        # print([word_to_id[x] for x in contents[i] if x in word_to_id])
...
if __name__ == '__main__':
    ...
    print("shape_of_x_pad: \n{}".format(np.shape(x_pad)))
    print('content_x_pad: \n{}'.format(x_pad))
    print("shape_of_y_pad: \n{}".format(np.shape(y_pad)))
    print('content_y_pad: \n{}'.format(y_pad))
